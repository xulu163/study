...
public class UpdateStudentDTO implements Serializable {
    ...
    protected List<UpdateStudentCourseDTO> courseList;
    ...
    public List<UpdateStudentCourseDTO> getCourseList() {
        return courseList;
    }

    public void setCourseList(List<UpdateStudentCourseDTO> courseList) {
