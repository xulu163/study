<template>
    <section style="position: relative;">
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;margin-top:0;">
            <el-form :inline="true" :model="importData" ref="importData">
                <el-form-item label="商户号：">
                    <el-input v-model="importData.mchId" placeholder="请输入商户号"></el-input>
                </el-form-item>
                <el-form-item label="定价方式：">
                    <el-radio v-model="importData.priceMethod" label="1">CPA</el-radio>
                    <el-radio v-model="importData.priceMethod" label="2">CPS</el-radio>
                </el-form-item>
                <el-form-item label="着陆页url：" v-if="importData.priceMethod == '1'">
                    <el-input v-model="importData.url" placeholder="请输入着陆页url"></el-input>
                </el-form-item>
                <el-button type="primary" class="importBtn"
                           @click="importExcel($event)"
                           v-loading="uploadLoading">导入</el-button>
            </el-form>
            <form>
                <input type="file"
                       name="fileup"
        ...
        <el-table :data="loanUserList" ref="multipleTable" @selection-change="handleSelectionChange"
            ...
            <el-table-column prop="id" label="客户ID" header-align="center" align="center" min-width="60">
            </el-table-column>
            ...
            <el-table-column prop="loanAmount" label="贷款金额(万)" header-align="center" align="center">
            </el-table-column>
            <el-table-column prop="customerPrice" label="价格(元)" header-align="center" align="center"></el-table-column>
            <el-table-column prop="customerSource" label="来源" header-align="center" align="center"></el-table-column>
            <!--<el-table-column prop="gmtCreate" label="注册时间" header-align="center" align="center"></el-table-column>-->
        ...
        <div id="modelAll">
            ...
            <el-dialog title="基本信息" custom-class="dialogBox" :visible.sync="editBannerDialog" width="80%">
                <el-form :model="editOutputData" :inline="true" :rules="editOutputRules" ref="editOutputRules"
                    ...
                    <el-form-item label="商机类型：" prop="priceMethod">
                        <el-select v-model="editOutputData.priceMethod" placeholder="请选择" class="searchInpt" clearable size="small">
                            <el-option v-for="item in priceMethodList" :key="item.label" :label="item.label"
                    ...
                    <el-form-item label="来源：">
                        <el-input v-model="editOutputData.customerSource" placeholder="请填写"  size="small"
                                  :disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="贷款金额：">
                        <el-input v-model="editOutputData.loanAmount" placeholder="请填写"
                                  size="small" :disabled="true"></el-input>
                        万
                    </el-form-item>
                    <el-form-item label="注册时间：">
                        <el-input v-model="editOutputData.registerTime" placeholder="请填写"
                                  size="small" :disabled="true"></el-input>

                    </el-form-item>
                    <el-form-item label="创建时间：">
                        <el-input v-model="editOutputData.gmtCreate" placeholder="请填写"
                                  size="small" :disabled="true"></el-input>
                    </el-form-item>
                    <div class="title">客户信息</div>
                    <el-form-item label="城市：">
                        <el-input v-model="editOutputData.city" placeholder="请填写"
                                  size="small" :disabled="true"></el-input>
                    </el-form-item>
                    <el-form-item label="微粒贷额度：">
                        <el-input v-model="editOutputData.particleLoan" placeholder="请填写"
                                  size="small" :disabled="true"></el-input>
                        万
                    </el-form-item>
                    <el-form-item label="是否有房：">
                        <el-radio v-model="editOutputData.houseStatus" label="有" disabled>有</el-radio>
                        <el-radio v-model="editOutputData.houseStatus" label="无" disabled>无</el-radio>
                    </el-form-item>
                    <el-form-item label="是否有车：">
                        <el-radio v-model="editOutputData.haveCar" label="有" disabled>有</el-radio>
                        <el-radio v-model="editOutputData.haveCar" label="无" disabled>无</el-radio>
                    </el-form-item>
                    <el-form-item label="是否有社保：">
                        <el-radio v-model="editOutputData.haveSocialSecurity" label="有" disabled>有</el-radio>
                        <el-radio v-model="editOutputData.haveSocialSecurity" label="无" disabled>无</el-radio>
                    </el-form-item>
                    <el-form-item label="是否有公积金：">
                        <el-radio v-model="editOutputData.haveAccumulationFund" label="有" disabled>有</el-radio>
                        <el-radio v-model="editOutputData.haveAccumulationFund" label="无" disabled>无</el-radio>
                    </el-form-item>
                    <el-form-item label="是否有寿险保单：">
                        <el-radio v-model="editOutputData.haveInsurancePolicy" label="有" disabled>有</el-radio>
                        <el-radio v-model="editOutputData.haveInsurancePolicy" label="无" disabled>无</el-radio>
                    </el-form-item>
                    <el-form-item label="有无银行代发工资：">
                        <el-radio v-model="editOutputData.bankPaysWages" label="有" disabled>有</el-radio>
                        <el-radio v-model="editOutputData.bankPaysWages" label="无" disabled>无</el-radio>
                    </el-form-item>
                    <el-form-item label="是否有信用卡：">
                        <el-radio v-model="editOutputData.haveCreditCard" label="有" disabled>有</el-radio>
                        <el-radio v-model="editOutputData.haveCreditCard" label="无" disabled>无</el-radio>
                    </el-form-item>
