<template>
    <section style="position: relative;">
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="searchParams" ref="statisticSearch">
                <el-form-item label="学生ID:">
                    <el-input v-model="searchParams.stuId" size="mini" style="width:100px"  clearable placeholder="请输入学生ID"></el-input>
                </el-form-item>
                <el-form-item label="学生姓名:">
                    <el-input v-model="searchParams.stuName" size="mini" style="width:120px"  clearable placeholder="请输入学生姓名"></el-input>
                </el-form-item>

                <el-form-item label="性别：">
                    <el-select v-model="searchParams.sex" size="mini" style="width:80px"  clearable placeholder="性别">
                ...
                <el-form-item label="课程:">
                  <el-select v-model="searchParams.courseId" size="mini" style="width:110px"  clearable placeholder="请选择课程">
                    <el-option v-for="item in course_list" :key="item.name" :label="item.name" :value="item.id" ></el-option>
                  </el-select>
                </el-form-item>
                ...
                <el-form-item label="创建时间" prop='createTimeStart'>
                    <el-date-picker type="date" v-model='searchParams.createTimeStart' size="mini" style="width:120px"  placeholder="年/月/日" ></el-date-picker>&nbsp;&nbsp;&nbsp;--
                </el-form-item>
                <el-form-item prop='createTimeEnd'>
                    <el-date-picker type="date"  v-model='searchParams.createTimeEnd' size="mini" style="width:120px"  placeholder="年/月/日"></el-date-picker>
                </el-form-item>
                <el-form-item label="教师:">
                    <el-input v-model="searchParams.teacherName" size="mini" style="width:100px"  clearable placeholder="请输入教师"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <!--列表-->
        <el-table :data="loanUserList" ref="multipleTable"  @sort-change="sortby"  v-loading="listLoading" border style="width: 100%;">
            <!-- <el-table-column type="index" label="序号" header-align="center" align="center" min-width="120"></el-table-column> -->
            <el-table-column prop="stuId" label="ID" header-align="center" align="center" min-width="190">

            </el-table-column>
            <el-table-column prop="stuName" label="学生姓名" header-align="center" min-width="100" align="center"></el-table-column>
            ...
            <el-table-column prop="courseName" label="课程" header-align="center" min-width="180" align="center"></el-table-column>
            <el-table-column prop="score" label="分数" sortable="custom" header-align="center" min-width="120" align="center"></el-table-column>
            ...
            <el-dialog title="学生详情" custom-class="dialogBox1" :visible.sync="detailDialog" width="100%">
                <el-form :model="addOutputData" :inline="true"  ref="detailRules" label-width="100px">
                    <el-row>
                      ...
                      <el-form-item label="" v-for="(item,key) in addOutputData.cursers" :key="key">
                          <el-checkbox v-model="item.ischeckeds" @change="clickCheck(item.ischeckeds,key)" label=""></el-checkbox>
                          <el-input v-model="item.name" placeholder="请填写" size="small" style="width:100px"></el-input>
      ...
      handleSizeChange(val){
        ...
        this.getLoanUserList();
          ...
          "totalCourseStart":this.searchParams.totalCourseStart,
				...
				getStuCourseList(params).then(res => {
					if (res.code == 0) {
						if (res.data.rows) {
